...
<div class="alert alert-warning">This article was written 9 months before official Perl6 release on XMas 2015. It contains instructions about how to build it from sources but you may want to use a tool like <a href="https://github.com/tadzik/rakudobrew">rakudobrew</a> to manage Perl6 installations.</div>
